...
SELECT @SPInfo = 
		CASE @ProductName
				WHEN 'SQL Server 2016' THEN 
											CASE @ProductLevel
												WHEN 'SP2' THEN @Temp1 
												ELSE 'Unsupported!!!, ' + @Temp12 + 'SP2, <https://www.microsoft.com/en-us/download/details.aspx?id=56836>'
											END
				WHEN 'SQL Server 2014' THEN 
											CASE @ProductLevel
												WHEN 'SP3' THEN @Temp1 
												WHEN 'SP1' THEN 'Unsupported!!!, ' + @Temp12 + ' SP3, <https://support.microsoft.com/en-us/help/4022619>'
												ELSE @Temp12 + 'SP3, <https://support.microsoft.com/en-us/help/4022619>'
											END
				WHEN 'SQL Server 2012' THEN
											CASE @ProductLevel
												WHEN 'SP4' THEN @Temp1 ELSE 'Unsupported!!!, ' + @Temp12 + 'SP4, <https://support.microsoft.com/en-us/kb/4018073>'
											END
				WHEN 'SQL Server 2008 R2' THEN
											CASE @ProductLevel
												WHEN 'Unsupported!!!, SP3' THEN @Temp1 ELSE 'Unsupported!!!, ' + @Temp12 + 'SP3, <https://support.microsoft.com/en-us/kb/2979597>'
											END
    ...
    @CUInfo = 
		CASE @ProductName
				WHEN 'SQL Server 2017' THEN CASE @ProductVersion
												WHEN '14.0.3238.1' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of RTM:  CU17, <https://support.microsoft.com/en-us/kb/4056498>'
											END
			    WHEN 'SQL Server 2016' THEN 
											CASE @ProductVersion
												WHEN '13.0.5492.2' THEN 'You have already installed the latest cumulative update.' 
												ELSE 'Install the latest Cumulative Update (CU) of SP1:  CU10, <https://support.microsoft.com/en-us/help/4524334>'
											END
				WHEN 'SQL Server 2014' THEN 
											CASE @ProductVersion
												WHEN '12.0.6329.1' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of SP3:  CU4, <https://support.microsoft.com/en-us/help/4500181>'
											END
				WHEN 'SQL Server 2012' THEN
											CASE @ProductVersion
												WHEN '11.0.7462.6' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of SP4:  RTW/PCU4, <https://support.microsoft.com/en-us/help/4057116>'
											END

				WHEN 'SQL Server 2008 R2' THEN
						CASE @ProductVersion
												WHEN '10.50.6560.0' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest fix of SP3, <https://support.microsoft.com/en-us/help/4057113>'
											END
				WHEN 'SQL Server 2008' THEN
						CASE @ProductVersion
												WHEN '10.0.6556.0' THEN 'You have already installed the latest cumulative update.'
												ELSE 'Install the latest Cumulative Update (CU) of SP4, <https://support.microsoft.com/en-us/help/4057114>'
											END
		END
...
BEGIN
	...
	BEGIN
        SET @CumulativeUpdate = 'CU10';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/979064';
    END
	ELSE IF (@ProductLevel = 'SP1') AND (@ProductVersion < '10.00.2850.0')
	BEGIN
        SET @CumulativeUpdate = 'CU16';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2582282';
    END
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '10.00.4333.00')
	BEGIN
        SET @CumulativeUpdate = 'CU11';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2715951';
    END
	ELSE IF (@ProductLevel = 'SP3') AND (@ProductVersion < '10.00.5861.00')
	BEGIN
        SET @CumulativeUpdate = 'CU17';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2958696';
    END
...
BEGIN
	...
	BEGIN
        SET @CumulativeUpdate = 'CU13';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2679366';
    END
	ELSE IF (@ProductLevel = 'SP1') AND (@ProductVersion < '10.50.2881.00')
	BEGIN
        SET @CumulativeUpdate = 'CU14';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2868244';
    END
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '10.50.4319.00')
	BEGIN
        SET @CumulativeUpdate = 'CU13';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2967540';
    END
...
BEGIN
	...
	BEGIN
        SET @CumulativeUpdate = 'CU11';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/2908007';
    END
	ELSE IF (@ProductLevel = 'SP1') AND (@ProductVersion < '11.0.3487.0')
	BEGIN
        SET @CumulativeUpdate = 'CU16';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/3052476';
    END
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '11.0.5678.0')
	BEGIN
        SET @CumulativeUpdate = 'CU16';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/3205054';
    END
	ELSE IF (@ProductLevel = 'SP3') AND (@ProductVersion < '11.0.6607.3')
	BEGIN
        SET @CumulativeUpdate = 'CU10';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4025925';
    END
	ELSE IF (@ProductLevel = 'SP4') AND (@ProductVersion < '11.0.7001.0')
	BEGIN
        SET @CumulativeUpdate = 'RTW/PCU4';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4018073';
    END
    SELECT @OtherProduct = 
			CASE 
				WHEN @ProductLevel = 'RTM' THEN ' If you want to upgrade to higher edition, please intall service pack.'
...
BEGIN
	...
	BEGIN
        SET @CumulativeUpdate = 'CU14';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/3158271';
    END
	ELSE IF (@ProductLevel = 'SP1') AND (@ProductVersion < '12.0.4522.0')
	BEGIN
        SET @CumulativeUpdate = 'CU13';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/help/3158271';
    END
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '12.0.5571.0')
	BEGIN
        SET @CumulativeUpdate = 'CU10';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4052725';
    END

	ELSE IF (@ProductLevel = 'SP3') AND (@ProductVersion < '12.0.5687.1')
	BEGIN
        SET @CumulativeUpdate = 'CU18';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4052725';
    END
		ELSE IF (@ProductLevel = 'SP4') AND (@ProductVersion < '12.0.6329.1')
	BEGIN
        SET @CumulativeUpdate = 'CU4';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4052725';
    END
...
BEGIN
	...
	BEGIN
        SET @CumulativeUpdate = 'CU9';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/kb/4037357';
    END
	ELSE IF (@ProductLevel = 'SP1') AND (@ProductVersion < '13.0.4574.0')
	BEGIN
        SET @CumulativeUpdate = 'CU15';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/help/4495257';
    END	
	ELSE IF (@ProductLevel = 'SP2') AND (@ProductVersion < '13.0.5492.2')
	BEGIN
        SET @CumulativeUpdate = 'CU10';
        SET @CumulativeUpdateKB = 'https://support.microsoft.com/en-us/help/4524334';
    END
    SELECT @OtherProduct = 
			CASE 
				WHEN @ProductLevel IN ('RTM','SP1') THEN 
...
select @ProductName as productname, @SPInfo as SPinfo, @ProductVersion, @ProductVersion , @ProductLevel as SPLevel, @UpdateLevel as CULevel, @Edition, @CumulativeUpdate as CUlatest, @CUInfo
